...
func TestPublicRouteExactAllowlist(t *testing.T) {
	cases := []struct {
		...
		{http.MethodGet, "/feed/abc"},
		{http.MethodGet, "/feed/abc/item/1/file"},
		{http.MethodGet, "/feed/abc/item/1/cover"},
		{http.MethodHead, "/feed/abc/item/1/file"},
