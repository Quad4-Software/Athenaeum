		...
		Sections: []APIDocSection{
			...
			},
			{
				...
				Endpoints: []APIDocEndpoint{
					...
					{Method: "GET", Path: "/api/tts/status", Summary: "Whether Kokoro TTS is enabled", Auth: "required"},
					{Method: "GET", Path: "/api/tts/voices", Summary: "List Kokoro voices", Auth: "required"},
					{Method: "POST", Path: "/api/tts/synthesize", Summary: "Synthesize speech via Kokoro sidecar", Auth: "required"},
